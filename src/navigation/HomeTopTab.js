...
import {View, Text, TextInput, StyleSheet, FlatList, Image,RefreshControl,Dimensions} from "react-native";
  ...
  function TitlePaper(){
    return (
      <View style={{
        ...
        <Text style={{fontSize: 13}}><View style={{backgroundColor: 10}} />新闻</Text>
        <Text style={{fontSize: 13, color: '#6495ed'}}>进入<Ionicons name={'ios-chevron-forward-sharp'} color={'#6495ed'} /></Text>
      </View>
    );
  }
  //分割线
